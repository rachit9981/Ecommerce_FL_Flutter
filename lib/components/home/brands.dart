...
// Method to get brands from API service and filter for mobile brands
      ...
      builder: (context, snapshot) {
        ...
        return Column(
          ...
          children: [
            ...
            HorizontalCategoryList(categories: mobileBrands, itemWidth: 80, itemHeight: 100, spacing: 12, showShadow: true),
            const SizedBox(height: 16),
          ],
        );
      },
